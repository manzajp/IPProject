                    ...
                    <div>
                        <script>
                            function formValidate(){
                                ...
                                let pword = document.forms["usersEditForm"]["pword"].value;
                        ...
                        <form name="usersEditForm" onsubmit="return formValidate()" action="<%= root %>/usersController?request=add" method="POST">
                            <div class="form-group">
                                <div>
                                    <table class="table table-bordered">
                                        <tr>
                                            <td class="table-dark col-2">Username</td>
                                            <td><input name="uname" id="uname" type="text" class="form-control" aria-describedby="unameHelp" placeholder="Enter a username"></td>
                                        </tr>
                                        <tr>
                                            <td class="table-dark col-2">Password</td>
                                            <td><input name="pword" id="pword" type="password" class="form-control" aria-describedby="pwordHelp" placeholder="Enter a password"></td>
                                        </tr>
                                        <tr>
